...
$sql2 = mysql_query("SELECT * FROM pengajuan5");
...
<section class="content-header">      
    <h1> Penilaian KP Mahasiswa Sebagai Dosen Pembimbing </h1>
    <ol class="breadcrumb">
        <li><a href="homepage.php?p=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Penilaian KP Mahasiswa Sebagai Pembimbing</li>
    </ol>
</section>
            ...
            <div class="row-fluid">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                            ...
                            <!-- form nama lengkap -->
                            <div class="form-group">
                                <label for="nama">Nama Lengkap Dosen Pembimbing</label>
...
$Nilai_Mahasiswa= trim($_POST['nama03']);
                    ...
                    if (isset($_POST['simpan'])) {
                        if ($ekstensi != $ekstensi_diperbolehkan) {
                            ...
                            if ($ukuran_file > $size) {
                                echo "<script language='javascript'>alert('Ukuran file terlalu besar');document.location='homepage.php?p=index07';</script>";
                            } else if ($ukuran_file < $size) {
                                $q = mysql_query("INSERT INTO pengajuan5 (nidn,nama_lengkap,file6,jenis_laporan,tgl_input,Nama_Mahasiswa,NIM_Mahasiswa,Nilai_Mahasiswa) VALUES ('$nidn','$nama_lengkap','$nama_file','$jenis_laporan','$tgl_input','$Nama_Mahasiswa','$NIM_Mahasiswa','$Nilai_Mahasiswa')");
                                if (mysql_affected_rows($connect) > 0) {
                                    echo "<script language='javascript'>alert('Laporan Anda Berhasil Diajukan');document.location='homepage.php?p=index07';</script>";
                                } else {
